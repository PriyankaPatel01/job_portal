  ...
  return (
    <div className='border p-6 shadow rounded'>
      <div className='flex justify-between items-center'>
        <img src={assets.company_icon} className='h-8' alt="company-logo" />
      </div>
      ...
      <div className='mt-4 flex gap-4 text-sm'>
        ...
        <button onClick={() => {navigate(`/apply-job/${job._id}`); scrollTo(0,0)}} className='text-gray-500 underline rounded px-4 py-2'>See More</button>
      </div>
    </div>
  )
}
